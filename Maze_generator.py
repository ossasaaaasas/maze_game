...
class Maze(object):
    ...
    def generate_matrix(self,mode,new_matrix):
        assert mode in [-1,0,1,2,3],"Mode {} doesn't exist.".format(mode)
        if mode==-1:
    ...
    def generate_matrix_split(self):
        ...
        #lr,lc: left corner row / column    rr,rc: right corner row / column
...
if __name__=='__main__':
    ...
    maze.print_matrix()
    maze.find_path(maze.destination)
